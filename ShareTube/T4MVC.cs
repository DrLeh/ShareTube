...
{
    public static ShareTube.Controllers.ShareTubeController ShareTube = new ShareTube.Controllers.T4MVC_ShareTubeController();
    public static ShareTube.Controllers.TrackingController Tracking = new ShareTube.Controllers.T4MVC_TrackingController();
...
namespace Links
{
    ...
    public static class Scripts {
        ...
        public static readonly string Hubs_tt = Url("Hubs.tt");
        public static readonly string Hubs_d_ts = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/Hubs.d.min.js") ? Url("Hubs.d.min.js") : Url("Hubs.d.js");
        ...
        public static readonly string ShareTubeHub_ts = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/ShareTubeHub.min.js") ? Url("ShareTubeHub.min.js") : Url("ShareTubeHub.js");
        public static readonly string TwitchEmotes_ts = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/TwitchEmotes.min.js") ? Url("TwitchEmotes.min.js") : Url("TwitchEmotes.js");
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public static class typings {
            ...
            public static class notify {
                private const string URLPATH = "~/Scripts/typings/notify";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                public static readonly string notify_d_ts = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/notify.d.min.js") ? Url("notify.d.min.js") : Url("notify.d.js");
            }
        
            [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
            public static class sharetube {
                private const string URLPATH = "~/Scripts/typings/sharetube";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                public static readonly string sharetube_ts = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/sharetube.min.js") ? Url("sharetube.min.js") : Url("sharetube.js");
            }
            ...
            public static class twitchemotes {
                private const string URLPATH = "~/Scripts/typings/twitchemotes";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                public static readonly string twitchemotes_d_ts = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/twitchemotes.d.min.js") ? Url("twitchemotes.d.min.js") : Url("twitchemotes.d.js");
            }
        
            [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
            public static class youtube {
                private const string URLPATH = "~/Scripts/typings/youtube";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                public static readonly string youtube_d_ts = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/youtube.d.min.js") ? Url("youtube.d.min.js") : Url("youtube.d.js");
            }
        
        }
    
        public static readonly string WatchTS_ts = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/WatchTS.min.js") ? Url("WatchTS.min.js") : Url("WatchTS.js");
    }
    ...
    public static class Content {
        ...
        public static class Images {
            ...
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
            public static readonly string Sharetube_png = Url("Sharetube.png");
        }
        ...
        public static readonly string Watch_less = Url("Watch.less");
        public static readonly string Watch_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/Watch.min.css") ? Url("Watch.min.css") : Url("Watch.css");
             
        public static readonly string Watch_css_map = Url("Watch.css.map");
        public static readonly string Watch_min_css = Url("Watch.min.css");
    }
    ...
    public static partial class Bundles
    {
        public static partial class Scripts 
        {
            public static partial class typings 
            {
                ...
                public static partial class sharetube 
                {
                    public static class Assets
                    {
                    }
                ...
                public static partial class twitchemotes 
                {
                    public static class Assets
                    {
                    }
            ...
            public static class Assets
            {
                ...
                public const string less_1_5_1_js = "~/Scripts/less-1.5.1.js"; 
                public const string less_1_5_1_min_js = "~/Scripts/less-1.5.1.min.js"; 
                public const string modernizr_2_8_3_js = "~/Scripts/modernizr-2.8.3.js"; 
                public const string notify_min_js = "~/Scripts/notify.min.js"; 
