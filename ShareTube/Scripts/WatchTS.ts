...
var videoQueryUrl: string = "https://www.googleapis.com/youtube/v3/videos?key=" + apiKey + "&part={0}&id={1}";
var searchStringFormat: string = "https://www.googleapis.com/youtube/v3/search?key=" + apiKey + "&part=snippet&q={0}&maxResults={1}&order={2}&type={3}";
var relatedUrlFormat: string = "https://www.googleapis.com/youtube/v3/search?key=" + apiKey + "&part=snippet&relatedToVideoId={0}&type=video";
...
var hubStarted = function () {
    ...
    $btnVideoAdd.click(function () {
        var videoUrl: string = $videoUrl.val();
...
var addVideo = function () {
    ...
    var name: string = $('#videourl').val("name").val(); //used to just be val("name");
    var author: string = "";
    enqueueVideo(url, name, author);
}
...
var videoQueueEntryFormatString: string = '<tr class="queuedVideo {0}" url="{1}" order="{2}" style="cursor:pointer"><td><span class="glyphicon glyphicon-play"></span>{3}</td></tr>';
